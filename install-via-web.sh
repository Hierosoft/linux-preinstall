...
if [ -z "$PROGRAM_PATH" ]; then
    PROGRAM_PATH=~/Downloads/git/Hierosoft/linux-preinstall
fi
...
if [ ! -d "$PROGRAM_PATH" ]; then
    ...
    git clone https://github.com/Hierosoft/linux-preinstall $PROGRAM_PATH || customExit "git clone https://github.com/Hierosoft/linux-preinstall failed."
