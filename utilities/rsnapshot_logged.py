...
def rsnapshot_logged(backup_type):
    ...
    with open(LOG, 'a') as logfile:
        ...
        logfile.write("last_run_utc='{}'".format(now_utc))
        logfile.write("last_run_local='{}'".format(now))
    ...
    if os.path.isdir(settings['snapshot_root']):
        ...
        with open("/opt/etc/rsnapshot-generated.rc") as stream:
            ...
            stream.write("last_run_utc='{}'".format(now_utc))
            stream.write(
                "last_run_utc_timestamp='{}'"
                .format(now_utc.timestamp()))
            stream.write("last_run_local='{}'".format(now))
            stream.write(
